    ...
    try {
      ...
      const transformedAlerts: InventoryAlert[] = data?.map(alert => ({
        ...
        product: {
          ...
          description: alert.products.description || undefined,
          ...
          sizes: alert.products.sizes as string[] | undefined,
          colors: alert.products.colors as string[] | undefined,
          image: alert.products.image_url || undefined,
          isActive: alert.products.is_active,
          isOffer: alert.products.is_offer || false,
          offerPrice: alert.products.offer_price || undefined,
